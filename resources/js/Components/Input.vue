<script setup>
    ...
    <template>
        <div class="relative mt-5">
            ...
            <label @click="focusToInput"  :class="get_class().label" class="absolute cursor-text text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1 z-0">
                {{ label }}
            </label>
        </div>
    </template>
